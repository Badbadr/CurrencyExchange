$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.each(data, function(index, currency) {
                    ...
                    row.append($('<td></td>').html('<button type="button" class="btn btn-secondary btn-sm currency-delete">x</button>'));
                    tbody.append(row);
                });
    ...
    $(document).delegate('.currency-delete', 'click', function() {
        // Get the currency and exchange rate from the row
        const code = $(this).closest('tr').find('td:first').text();
        $('#delete-currency-modal #delete-input').val(code);
        $('#delete-currency-modal').modal('show');
    });

    // add event handler for delete currency
    $('#delete-currency-modal .btn-primary').click(function() {
        // get the currency pair and exchange rate from the modal
        const code = $('#delete-currency-modal #delete-input').val();
